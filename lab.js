...
//Code here
favoriteThings.car = "Mitsubishi Lancer Evolution IX"
favoriteThings.show = "Castlevania"
...
let cosmo = new Cat("Cosmo", 1, "black")
...
let sypha = new Wizard("Sypha", 25, "conjure elemental")
console.log(sypha.castSpell())
...
//Code Here
let sung = new Phone(
  "Samsung", "Galaxy S9", 16, "lilac", 500
)
let app = new Phone(
  "Apple", "iPhone X", 16, "red", 600
)
let old = new Phone(
  "Nokia", "Brick", 1, "blue", 20
)
/* 
...
//Code Here
let myFirstVehicle = new Vehicle(5, "maroon", 94832)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, "green", 20501, "Ducati", true)
...
//Code Here
const myFirstBoat = new Boat(20, "white", 40, "Water Log", "yacht", false);
/*
